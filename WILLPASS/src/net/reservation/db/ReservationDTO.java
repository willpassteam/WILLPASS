...
public class ReservationDTO {
	  ...
	  private boolean reser_round_trip; //왕복 편도 여부 
	...
	public ReservationDTO(String reser_familyname, String reser_gender, Date reser_date, String reser_givenname,
			...
			String reser_reserved_seat, boolean reser_round_trip) {
		super();
	...
	public boolean isReser_round_trip() {
		return reser_round_trip;
	}
	public void setReser_round_trip(boolean reser_round_trip) {
		this.reser_round_trip = reser_round_trip;
	}
