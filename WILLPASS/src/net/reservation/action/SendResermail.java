...
public class SendResermail {
	...
	void sendEmail(String email,ArrayList Reservationarr1 ,ArrayList Reservationarr2) { //예약완료 이메일을 보내는 함수 
    		...
    		String content="<!DOCTYPE html><html><head><meta charset='UTF-8'><title>Insert title here</title><style>"
    				+"</style></head><body style='width: 1000px'><div align='center'><div align='center'><img src='	https://mail.naver.com/read/image/?mailSN=105&attachIndex=2&contentType=image/png&offset=1374&size=4592&maxSize=200&mimeSN=1565155877.962917.30992.1792&u=sobbam94'><h3 >항공권 예약/결제 확인</h3>"
