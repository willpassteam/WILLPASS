				...
				<div class="row ">
					<div class="col-sm-6">
						...
						<div class="row">
							...
							<div class="col-sm-7">
								<input type="email" name="user_email" id="user_email"  class="form-control mb-0" placeholder="이메일 주소" ><br>
								<input type="password" id="user_pwd" name="user_pwd"  class="form-control mt-0" placeholder="비밀번호">
								<br>
					...
					<div class="col-sm-6">
						...
						<div class="row">
							...
							<div class="col-sm-7 mr-0 pr-0">
								<input type="email"  class="form-control" name="user_email"  class="form-control mb-0" placeholder="이메일 주소" ><br>
							</div>
...
<!--오른쪽부분 -->
					...
					<textarea rows="10" cols="60" style="text-align: left;resize: none;" readonly="readonly">
